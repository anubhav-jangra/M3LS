...
class bbcSpider(scrapy.Spider):
  ...
  #  start_urls = ['https://bbc.in/3o4Um2j','https://bbc.in/3i3Ijyw']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('telugu/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
