...
#    start_urls = ['https://www.bbc.com/sinhala/sri-lanka-58142243']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('sinhala/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
         ...
         #   elif i.css('p>b') and flag == True:
          ...
          #      c = ''.join(r)
            ...
            # Else paragraph normal
                ...
                if (i.css('a')):
                    if "Also read" in i.css('::text').getall()  or 'Telegram' in i.css('::text').getall(): # modify this for punjabi
                        continue
