...
#    start_urls = ['https://www.bbc.com/urdu/entertainment-47758658']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('urdu/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
