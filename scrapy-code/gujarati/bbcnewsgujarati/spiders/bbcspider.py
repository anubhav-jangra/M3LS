...
class bbcSpider(scrapy.Spider):
  ...
  #  start_urls = ['https://bbc.in/3kCCs4G','https://bbc.in/3AExZEt']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('gujarati/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
