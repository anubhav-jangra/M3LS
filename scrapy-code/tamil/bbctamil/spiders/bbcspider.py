...
#    start_urls = ['https://bbc.in/3ENQGb0']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('tamil/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
