...
class bbcSpider(scrapy.Spider):
   ...
   # start_urls = ['https://bbc.in/3mQeX8f', 'https://bbc.in/3iZNgZE']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('ukrainian/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
         ...
         #   elif i.css('p>b') and flag == True:
          ...
          #      c = ''.join(r)
            ...
            # Else paragraph normal
                ...
                if (i.css('a')):
                    if "Viber" in i.css('::text').getall()  and 'Telegram' in i.css('::text').getall(): # ukranian
                        continue
