...
#    start_urls = ['https://bbc.in/2Y228PI']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('portuguese/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
