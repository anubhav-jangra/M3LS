...
class bbcSpider(scrapy.Spider):
    ...
    #start_urls = ['https://bbc.in/3BCElof','https://bbc.in/3AD2z0r']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('indonesia/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
