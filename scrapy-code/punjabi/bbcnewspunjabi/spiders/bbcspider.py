...
#   start_urls = ['https://bbc.in/3ucBejR', 'https://bbc.in/3o2ZkN9']
    ...
    def parse(self, response):
        ...
        try:
            domain = domain_split(url_main.split('punjabi/')[1])  # generalize this (Tentative: Different language scrapers will only have this field different and
        except:
            domain = "NA"
